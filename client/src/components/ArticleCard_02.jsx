      ...
      <div className={`article-card-inner ${active ? "open" : "close"}`}>
        <div className="image-box relative">
          ...
          <div className="absolute bottom-2 left-1 flex gap-1">
            <div className="bg-white/80 uppercase text-xs px-2 rounded-full flex items-center justify-center">
              <span>{article.user_id.username}</span>
            </div>
            {article.tradeOption ? (
              <div
                className="bg-white/80 px-1 py-1 text-sm rounded-full flex items-center justify-center relative tooltip"
                onClick={(e) => {
                  e.stopPropagation();
        ...
        <div className={`card-content ${active ? "open" : "close"}`}>
          <div className="relative">
            <h2
              className={`mt-4 ${active ? "clamp-line" : "clamp-line-1"} ${
          ...
          <Collapse isOpened={active}>
            ...
            <div className="tags">
              ...
              {article.subCategory && (
                <span className="inline-block bg-orange-300/10 rounded-full px-3 py-1 text-xs text-gray-700 mr-2 mb-1">
            ...
            <button className="btn-md btn-teal" onClick={gotoSingle}>
              Infos
            </button>
          </Collapse>
        </div>
